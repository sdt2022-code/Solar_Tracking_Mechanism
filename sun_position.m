...
% Add Hour Angle 
topocentric_sun_position.hourangle =  observer_local_hour; 

function topocentric_local_hour = topocentric_local_hour_calculate(observer_local_hour, topocentric_sun_position)
% This function compute the topocentric local hour angle in degrees
...
% Extract Declination Angle 
sun.declination = topocentric_sun_position.declination;
% Extract Hour Anlge 
sun.HourAngle = topocentric_local_hour; 
% sun.HourAngle = topocentric_sun_position.hourangle;
